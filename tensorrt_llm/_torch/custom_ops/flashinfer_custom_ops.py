...
if IS_FLASHINFER_AVAILABLE:
    ...
    def flashinfer_silu_and_mul(x: torch.Tensor) -> torch.Tensor:
        return silu_and_mul(x, enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_SILU_AND_MUL"))
    ...
    def flashinfer_gelu_tanh_and_mul(x: torch.Tensor) -> torch.Tensor:
        return gelu_tanh_and_mul(x, enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_GELU_TANH_AND_MUL"))
    ...
    def flashinfer_rmsnorm(input: torch.Tensor, weight: torch.Tensor,
        ...
        return rmsnorm(input, weight, eps, enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_RMSNORM"))
    ...
    def flashinfer_gemma_rmsnorm(input: torch.Tensor, weight: torch.Tensor,
        ...
        return gemma_rmsnorm(input,
                             weight,
                             eps,
                             enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_GEMMA_RMSNORM"))
    ...
    def flashinfer_fused_add_rmsnorm(input: torch.Tensor,
        ...
        fused_add_rmsnorm(input,
                          ...
                          weight,
                          eps,
                          enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_FUSED_ADD_RMSNORM"))
    ...
    def flashinfer_fused_add_rmsnorm_quant(out: torch.Tensor,
        ...
        fused_add_rmsnorm_quant(out,
                                ...
                                scale,
                                eps,
                                enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_FUSED_ADD_RMSNORM_QUANT"))
    ...
    def flashinfer_gemma_fused_add_rmsnorm(input: torch.Tensor,
        ...
        gemma_fused_add_rmsnorm(input,
                                ...
                                weight,
                                eps,
                                enable_pdl=get_env_enable_pdl_for_kernel("TRTLLM_DISABLE_PDL_FLASHINFER_GEMMA_FUSED_ADD_RMSNORM"))
