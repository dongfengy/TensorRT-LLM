...
class NVFP4TRTLLMGenFusedMoEMethodBase(NVFP4FusedMoEMethod):
...
class NVFP4TRTLLMGenFusedMoEMethod(NVFP4TRTLLMGenFusedMoEMethodBase):
    weight_alignment = 32
...
class W4A8NVFP4FP8TRTLLMGenFusedMoEMethod(NVFP4TRTLLMGenFusedMoEMethodBase):
